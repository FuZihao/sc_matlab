...
test1 = imread('./data/archery/archery-template.jpg');
test2 = imread('./data/archery/archery-07.jpg');

test1_g = rgb2gray(test1);
test2_g = rgb2gray(test2);

test1_g = double(test1_g);
test2_g = double(test2_g);

test1_g_n = mat2gray(test1_g,[0,1]);
test2_g_n = mat2gray(test2_g,[0,1]);

%test1_g_n = 1 - test1_g_n;
%test2_g_n = 1 - test2_g_n;

V1 = imresize(test1_g_n, [28,28]);
V2 = imresize(test2_g_n, [28,28]);
