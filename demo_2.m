...
%  debug
   debug_costmat_shape_s = costmat_shape;
   debug_theta_diff_s = theta_diff;
...
% debug
debug_ssd_local_s =  ssd_local;
debug_ssd_local_avg_s = ssd_local_avg;
