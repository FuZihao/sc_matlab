...
while s
   ...
   [BH2,mean_dist_2]=sc_compute(Y',zeros(1,nsamp2),mean_dist_global,nbins_theta,nbins_r,r_inner,r_outer,out_vec_2);
...
%   cvec=hungarian_fast(costmat2);
   ...
   [a,cvec2]=sort(cvec); % outlier is behind inlier
   out_vec_1=cvec2(1:nsamp1)>nsamp2; % doubtable!
   out_vec_2=cvec(1:nsamp2)>nsamp1; % correspond to esp
